...
void HUD::generateMesh() {
    ...
    boxVAO.LinkAttrib(VBO1, 0, 2, GL_FLOAT, 6 * sizeof(float), (void*)0);
    boxVAO.LinkAttrib(VBO1, 1, 3, GL_FLOAT, 6 * sizeof(float), (void*)(2 * sizeof(float)));
    boxVAO.LinkAttrib(VBO1, 2, 1, GL_FLOAT, 6 * sizeof(float), (void*)(5 * sizeof(float)));
...
void GUIItem::genBox() {
    box = {
        float(width / float(windowWidth)) + float(2 * position.x / float(windowWidth)), float(height / float(windowHeight)) + float(2 * position.y / float(windowHeight)), color.x, color.y, color.z, 0,
        float(-width / float(windowWidth)) + float(2 * position.x / float(windowWidth)), float(height / float(windowHeight)) + float(2 * position.y / float(windowHeight)), color.x, color.y, color.z, 0,
        float(width / float(windowWidth)) + float(2 * position.x / float(windowWidth)), float(-height / float(windowHeight)) + float(2 * position.y / float(windowHeight)), color.x, color.y, color.z, 0,
        float(-width / float(windowWidth)) + float(2 * position.x / float(windowWidth)), float(-height / float(windowHeight)) + float(2 * position.y / float(windowHeight)), color.x, color.y, color.z, 0,
    };
